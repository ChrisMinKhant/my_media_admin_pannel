    ...
    <div class="row">
        ...
        <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data"
            ...
            <div class="my-5">
                ...
                <span class="fs-6 fw-light text-uppercase d-block">You can create a category here.</span>
            </div>
            {{-- Greeting Text End --}}
            ...
            <div class="form-floating">
                ...
                is-invalid
                @enderror"
                    placeholder="Description" id="floatingTextarea2" style="height: 100px" name="description"></textarea>
                @error('description')
                    <small class="text-danger float-start">{{ $message }}</small>
                @enderror
