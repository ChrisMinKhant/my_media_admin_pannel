        ...
        <div class="row text-center">
            <div class="rounded-5 shadow-lg p-3 border border-dark border-2 col-6 offset-3 my-5 ">
                <div class="my-3">
                    ...
                    <span class="fs-6 fw-light text-uppercase d-block">here is post details.</span>
                </div>
                {{-- Profile Start --}}
                <div class="my-5 mx-3">
                    <img src="{{ asset('storage/' . $postData->image) }}" class="mb-4" style="width:25%;">
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="btn btn-sm btn-dark shadow-sm rounded-5 fw-bold ms-2">Created At :
                            {{ $postData->created_at->format('Y-M-d') }}
                        </div>
                    </div>
                    <div class="d-flex mt-4">
                        ...
                        <div class="btn btn-sm btn-dark shadow-sm rounded-5 fw-bold ms-2">Comment :
                            {{ $commentCountData }}
                        </div>
                    </div>

                    <div class="row mt-4">
                        <div class="text-muted fs-5 text-start fw-bold">Category</div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="{{ route('post.edit', $postData->id) }}" class="btn btn-dark rounded-5 w-100"><i
